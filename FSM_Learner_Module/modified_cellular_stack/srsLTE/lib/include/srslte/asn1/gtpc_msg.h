...
const uint8_t GTPC_MSG_TYPE_CREATE_SESSION_REQUEST_TAU  = 50;
    ...
    const uint8_t GTPC_MSG_TYPE_CREATE_SESSION_REQUEST_REPLAY  = 52;
    const uint8_t GTPC_MSG_TYPE_CREATE_SESSION_RESPONSE_REPLAY = 53;
const uint8_t GTPC_MSG_TYPE_CREATE_SESSION_REQUEST_DOWNGRADED  = 54;
const uint8_t GTPC_MSG_TYPE_CREATE_SESSION_RESPONSE_DOWNGRADED = 55;
