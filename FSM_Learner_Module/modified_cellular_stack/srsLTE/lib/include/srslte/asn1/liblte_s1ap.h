...
typedef enum {
  ...
  LIBLTE_S1AP_PROC_ID_INITIALCONTEXTSETUP_REPLAY                  = 51,
  LIBLTE_S1AP_PROC_ID_INITIALCONTEXTSETUP_DOWNGRADED                  = 52,
...
typedef enum {
  ...
  LIBLTE_S1AP_UEPAGINGID_CHOICE_IMSI_TMSI,//TODO: need to check if that works
...
/*******************************************************************************
/* Protocol Message InitialContextSetupRequestReplay STRUCT
********************************************************************************/
typedef struct {
    bool                                               ext;
    LIBLTE_S1AP_MME_UE_S1AP_ID_STRUCT                  MME_UE_S1AP_ID;
    ...
    LIBLTE_S1AP_ADDITIONALCSFALLBACKINDICATOR_ENUM_EXT AdditionalCSFallbackIndicator;
    bool                                               AdditionalCSFallbackIndicator_present;
} LIBLTE_S1AP_MESSAGE_INITIALCONTEXTSETUPREQUESTREPLAY_STRUCT;

LIBLTE_ERROR_ENUM liblte_s1ap_pack_initialcontextsetuprequestreplay(LIBLTE_S1AP_MESSAGE_INITIALCONTEXTSETUPREQUESTREPLAY_STRUCT* ie,
                                                              uint8_t** ptr);
LIBLTE_ERROR_ENUM
liblte_s1ap_unpack_initialcontextsetuprequestreplay(uint8_t** ptr, LIBLTE_S1AP_MESSAGE_INITIALCONTEXTSETUPREQUESTREPLAY_STRUCT* ie);

/*******************************************************************************
/* Protocol Message InitialContextSetupRequestDowngraded STRUCT
********************************************************************************/
typedef struct {
  bool                                               ext;
  LIBLTE_S1AP_MME_UE_S1AP_ID_STRUCT                  MME_UE_S1AP_ID;
  ...
  LIBLTE_S1AP_ADDITIONALCSFALLBACKINDICATOR_ENUM_EXT AdditionalCSFallbackIndicator;
  bool                                               AdditionalCSFallbackIndicator_present;
} LIBLTE_S1AP_MESSAGE_INITIALCONTEXTSETUPREQUESTDOWNGRADED_STRUCT;

LIBLTE_ERROR_ENUM liblte_s1ap_pack_initialcontextsetuprequestdowngraded(LIBLTE_S1AP_MESSAGE_INITIALCONTEXTSETUPREQUESTDOWNGRADED_STRUCT* ie,
                                                                    uint8_t** ptr);
LIBLTE_ERROR_ENUM
liblte_s1ap_unpack_initialcontextsetuprequestdowngraded(uint8_t** ptr, LIBLTE_S1AP_MESSAGE_INITIALCONTEXTSETUPREQUESTDOWNGRADED_STRUCT* ie);
...
typedef enum {
  ...
  LIBLTE_S1AP_INITIATINGMESSAGE_CHOICE_INITIALCONTEXTSETUPREQUEST_REPLAY,
  LIBLTE_S1AP_INITIATINGMESSAGE_CHOICE_INITIALCONTEXTSETUPREQUEST_DOWNGRADED,
  LIBLTE_S1AP_INITIATINGMESSAGE_CHOICE_N_ITEMS
} LIBLTE_S1AP_INITIATINGMESSAGE_CHOICE_ENUM;
static const char liblte_s1ap_initiatingmessage_choice_text[LIBLTE_S1AP_INITIATINGMESSAGE_CHOICE_N_ITEMS][52] = {
    ...
    "ENBStatusTransfer",
    "ErrorIndication",
    "InitialContextSetupRequestReplay",
    "InitialContextSetupRequestDowngraded"
};

typedef union {
  LIBLTE_S1AP_MESSAGE_INITIALCONTEXTSETUPREQUESTREPLAY_STRUCT     InitialContextSetupRequestReplay;
  LIBLTE_S1AP_MESSAGE_INITIALCONTEXTSETUPREQUESTDOWNGRADED_STRUCT InitialContextSetupRequestDowngraded;
