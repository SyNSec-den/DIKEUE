...
const char* gtpc_msg_type_to_str(uint8_t type)
{
  switch (type) {
    ...
    case GTPC_MSG_TYPE_CREATE_SESSION_REQUEST_REPLAY:
      return "GTPC_MSG_TYPE_CREATE_SESSION_REQUEST_REPLAY";
    case GTPC_MSG_TYPE_CREATE_SESSION_REQUEST_TAU:
      return "GTPC_MSG_TYPE_CREATE_SESSION_REQUEST_TAU";
