...
public:
  ...
  bool send_initial_context_setup_request_replay(nas* nas_ctx, uint16_t erab_to_setup);
  bool send_initial_context_setup_request_downgraded(nas* nas_ctx, uint16_t erab_to_setup);
