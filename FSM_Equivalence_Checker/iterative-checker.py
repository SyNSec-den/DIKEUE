...
def do_iterative_checker(outNuXmv, commandFile, outDiff):
    global all_incoming_messages
    global io_map
    global all_list
    ...
    for i in range (len(all_incoming_messages)-1, -1, -1):
        ...
        for j in list(perm):
            ...
            out = checker.compute_diff( outNuXmv, commandFile, outDiff, all_incoming_messages[i], j[0], j[1])
            if out == []:
                continue
            if j[0] != "null_action" and j[1] != "null_action":
...
def main(fsm1_inFile, fsm2_inFile, outNuXmv, commandFile, outDiff):
    ...
    do_iterative_checker(outNuXmv, commandFile, outDiff)
    return
...
if __name__ == "__main__":
    ...
    parser.add_argument('-lts1', dest='lts1_dot_file', default="FSM/FSM1-ue-nas.dot", help="UE NAS LTS")
    parser.add_argument('-lts2', dest='lts2_dot_file', default="FSM/FSM2-ue-nas.dot",
