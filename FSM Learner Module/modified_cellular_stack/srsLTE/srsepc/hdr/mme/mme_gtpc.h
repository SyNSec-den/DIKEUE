...
public:
  ...
  virtual bool send_create_session_request(uint64_t imsi);
    virtual bool send_create_session_request_replay(uint64_t imsi);
    virtual bool send_create_session_request_downgraded(uint64_t imsi);
  ...
  bool         handle_create_session_response(srslte::gtpc_pdu* cs_resp_pdu);
    ...
    bool         handle_create_session_response_replay(srslte::gtpc_pdu* cs_resp_pdu);
    bool         handle_create_session_response_downgraded(srslte::gtpc_pdu* cs_resp_pdu);
