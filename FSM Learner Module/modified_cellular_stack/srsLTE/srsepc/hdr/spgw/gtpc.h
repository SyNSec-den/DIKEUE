...
public:
  ...
  void handle_create_session_request_replay(const srslte::gtpc_create_session_request& cs_req);
  void handle_create_session_request_downgraded(const srslte::gtpc_create_session_request& cs_req);
