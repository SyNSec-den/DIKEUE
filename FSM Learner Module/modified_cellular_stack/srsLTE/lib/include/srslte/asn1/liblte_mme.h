...
// Defines
// Protocol Descriptor
#define LIBLTE_MME_MSG_PROTOCOL_DISCRIMINATOR_CP_DATA 0x9
#define LIBLTE_MME_MSG_TRANSITION_IDENTIFIER_CP_DATA 0x9
#define LIBLTE_MME_MSG_TYPE 0x0001
...
LIBLTE_ERROR_ENUM liblte_mme_pack_authentication_request_msg_mac(LIBLTE_MME_AUTHENTICATION_REQUEST_MSG_STRUCT* auth_req,
                                                             LIBLTE_BYTE_MSG_STRUCT*                       msg,     uint8  sec_hdr_type,
                                                                 uint32 count);
...
LIBLTE_ERROR_ENUM liblte_mme_pack_identity_request_msg(LIBLTE_MME_ID_REQUEST_MSG_STRUCT* id_req,
                                                       LIBLTE_BYTE_MSG_STRUCT*           msg);
LIBLTE_ERROR_ENUM liblte_mme_pack_identity_request_msg_mac(LIBLTE_MME_ID_REQUEST_MSG_STRUCT* id_req,LIBLTE_BYTE_MSG_STRUCT*  msg,uint32 count, uint8    sec_hdr_type);
...
typedef struct {
    ...
    bool                                                     device_properties_present;
    bool                                                     old_guti_type_present;
} LIBLTE_MME_TAU_REQUEST_MSG_STRUCT;
